...
var require_react_contenteditable = __commonJS({
  "node_modules/react-contenteditable/lib/react-contenteditable.js"(exports) {
    ...
    var ContentEditable2 = function(_super) {
      __extends(ContentEditable3, _super);
      function ContentEditable3() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.lastHtml = _this.props.html;
        _this.el = typeof _this.props.innerRef === "function" ? { current: null } : React6.createRef();
      ...
      ContentEditable3.prototype.render = function() {
        ...
        return React6.createElement(tagName || "div", __assign(__assign({}, props), { ref: typeof innerRef === "function" ? function(current) {
          innerRef(current);
      ...
      ContentEditable3.prototype.shouldComponentUpdate = function(nextProps) {
        ...
        return props.disabled !== nextProps.disabled || props.tagName !== nextProps.tagName || props.className !== nextProps.className || props.innerRef !== nextProps.innerRef || props.placeholder !== nextProps.placeholder || !fast_deep_equal_1.default(props.style, nextProps.style);
      };
...
var toMarkdown = (values, colJustify, isInsideCallout) => {
  ...
  alignMarker = alignMarker.split("|").splice(1).splice(0, alignMarker.length - 2).map((part, idx) => {
...
var Cell = ({ row, col, content, onContentChanged, values, setValues, colJustify, setColJustify, autoFocus = false, onFocus }) => {
  ...
  }, /* @__PURE__ */ React3.createElement(import_react_contenteditable.default, {
    className: "mte cell",
...
// src/views/TableEditor.tsx
var TableEditor = ({ leafId, cursor, inputData, updateViewData, supressNotices = false }) => {
  var _a;
  let _leafid = leafId;
  let _cursor = cursor;
  const app = useApp();
...
${afterValue}`}`;
  ...
  const replaceClicked = () => {
    ...
    let view = app.workspace.getActiveViewOfType(import_obsidian2.MarkdownView);
  ...
  }, values.map((row, rowIdx) => row.map((value, colIdx) => /* @__PURE__ */ React4.createElement(Cell_default, {
    key: `${rowIdx}-${colIdx}`,
    row: rowIdx,
    col: colIdx,
    content: value,
